...
public interface IPersistence {
     ...
     * @throws IOException
     */
    public boolean createUserNewUserInDatabase(IUser user) throws IOException;
     ...
     */
    public boolean createBroadcastInDatabase(IBroadcast broadcast);
     ...
     */
    public boolean createProductionInDatabase(IProduction production);
     ...
     */
    public boolean createCastInDatabase(ICast cast);
